...
print "Command used :perl offline_rfeet $bam_file\t$fasta_file\t$gene_list\t$bam_file_rnaseq\t$plottype\t$legend1\t$legend2\t$cov_plot\t$offset1\t$readlen1\t$bam_file_rnaseq\t$readlen2\t$offset2\n";
